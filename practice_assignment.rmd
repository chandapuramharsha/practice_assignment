...
###11) Here is my code & output for the first part of assignment1. Please let me know what could be the problem ?
...
+     }
+     pollutant_subset <- dat[which(dat[, "pollutant"] == pollutant) , ]
+     mean(pollutant_subset[,"pollutant"], NA.rm = TRUE)
+ }
>     pollutantmean ("specdata", "sulfate", 1:10)
Error in `[.data.frame`(dat, , "pollutant") : undefined columns selected
Called from: `[.data.frame`(dat, , "pollutant")
Browse[1]> 
